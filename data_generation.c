...
void print_array(int A[data_points][input_size])
{
    printf("\n");
    int m,n;
    for (m=0;m<data_points;m++)
        {   
...
int main(){
    ...
    int input_set[data_points][input_size]; //set of inputs 
    int output_set[data_points][input_size]; //set of outputs
